...
export const unitDataKeys: Set<UnitDataKey> = new Set([
    "ua1m",
    "backSw1",
    "dmgpt1",
    "dmgplus1",
...
export const heroUnitDataKeys: Set<HeroUnitDataKey> = new Set([
    "heroAbilList",
    "Propernames",
    "nameCount",
    "Revivetip",
...
export const unitAndHeroDataKeys: Set<HeroUnitDataKey> = unitDataKeys

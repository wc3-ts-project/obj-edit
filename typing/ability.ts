...
export type HeroAbilityData = AbilityData & {
    /**
...
export const abilityDataKeys: Set<AbilityDataKeys> = new Set([
    "Animnames",
    "Missileart",
    "MissileHoming",
    "Targetattach",
...
export const heroAbilityDataKeys: Set<HeroAbilityDataKeys> = new Set([
    "Researchtip",
    "Researchubertip"
])

export const abilityAndHeroDataKeys: Set<HeroAbilityDataKeys> = abilityDataKeys

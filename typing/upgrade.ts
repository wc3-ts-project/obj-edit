 ...
 * Магия - caster
 */
export type UpgradeClass = "_" | "armor" | "artillery" | "melee" | "ranged" | "caster"
...
export const upgradeDataKeys: Set<UpgradeDataKeys> = new Set([
    "gbpx",
    "gbpy",
    "effect",
    "base",
...
export type UpgradeDataKeys = keyof UpgradeData
